...
module BoltServer
  class PluginCache
    ...
    def with_synced_libdir(environment, enforce_environment, certname, &block)
      ForkUtil.isolate do
        BoltServer::PuppetUtil.isolated_puppet_settings(
          certname,
          environment,
          enforce_environment,
    ...
    # the bolt config, with the appended environments, i.e.
    # /opt/puppetlabs/server/data/bolt-server/cache/environments
